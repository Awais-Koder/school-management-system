...
class BsOneStudentTestImporter extends Importer
{
    ...
    {
        $body = 'Your bs one student test import has completed and ' . number_format($import->successful_rows) . ' ' . str('row')->plural($import->successful_rows) . ' imported.';
