...
class BsTwoExporter extends Exporter
{
    ...
    {
        $body = 'Your bs two export has completed and ' . number_format($export->successful_rows) . ' ' . str('row')->plural($export->successful_rows) . ' exported.';
